...
Module({
  ...
  return await message.client.sendMessage(message.jid,{document: {url: res.dl_url},fileName:res.title,caption:'_*File:* '+res.title+'_',mimetype:'application/x-subrip'},{quoted:message.data})
